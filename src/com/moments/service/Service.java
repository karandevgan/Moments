...
public class Service {
	...
	@Transactional
	public boolean deleteAlbum(String album_to_delete, String album_name,
			User user) {
	...
	public boolean uploadImage(Album album, User user, MultipartFile file) {
		...
		try {
			...
			String thumb_url = cloudinary
					.url()
					.transformation(
							new Transformation().height(200).crop("scale"))
	...
	public List<Photo> getPhotos(String album_name, User user, int call) {
		return photoDao.getPhotos(
				albumDao.getAlbum(album_name, user.getUser_id()), user, call);
	}
